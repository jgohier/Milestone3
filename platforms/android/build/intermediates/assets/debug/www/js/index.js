...
var app = {
    ...
    loadTemplates: function(){
      var templates = ['entries', 'addEntryForm', 'entry', 'manageEntries', 'editEntryForm' ];
    ...
    route: function(path){
	  ...
	  if(path === '/manage'){
        console.log('inside');
        app.render('container', 'manageEntries', {posts: app.posts});
        return
      }
	...
	editEntry: function(evt){
      ...
      var currentEntry = {id: entryID, slug: slug, body: body};
		
	  app.render("container", "editEntryForm", {current: currentEntry, posts: app.posts})
	},
	updateEntry: function(evt){
      ...
      var updatedEntry = {slug: slug, body: body};

      app.posts[entryID] = updatedEntry;
      util.store('posts', app.posts)
